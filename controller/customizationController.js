import MoneyPool from "../db/models/MoneyPool.model.js";

export const createMoneyPool = async (req, res) => {
    try {
...
export const getMoneyPools = async (req, res) => {
    try {
...
export const updateMoneyPool = async (req, res) => {
    try {
...
export const deleteMoneyPool = async (req, res) => {
    try {
...
import DummyFriend from "../db/models/DummyFriend.model.js";

export const createDummyFriend = async (req, res) => {
    try {
...
export const getDummyFriends = async (req, res) => {
    try {
...
export const updateDummyFriend = async (req, res) => {
    try {
...
export const deleteDummyFriend = async (req, res) => {
    try {
...
import TransactionCategory from "../db/models/TransactionCategory.model.js";
...
import TransactionGroup from "../db/models/TransactionGroup.model.js";
export const createTransactionGroup = async (req, res) => {
    try {
...
export const getTransactionGroups = async (req, res) => {
    try {
...
export const updateTransactionGroup = async (req, res) => {
    try {
        const updates = req.body;
